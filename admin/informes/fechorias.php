...
Fechoria.notas, Fechoria.asunto, Fechoria.informa, Fechoria.claveal, grave FROM Fechoria, alma WHERE alma.claveal = Fechoria.claveal
 AND alma.claveal = $claveal ORDER BY Fechoria.fecha DESC, alma.unidad, alma.apellidos"); ?>
