...
while ($unidad = mysqli_fetch_array($unidades)) {
	...
	$result = mysqli_query($db_con, "SELECT nc, CONCAT(apellidos,', ',nombre) AS alumno, claveal FROM alma WHERE unidad='$unidad' and claveal in (select claveal from alma,tcombasi where alma.claveal1 = tcombasi.claveal1 and cmateria = '141430' OR cmateria = '141434') ORDER BY nc ASC");
